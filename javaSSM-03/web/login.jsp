    ...
    <script type="text/javascript">
        <%
            ...
            if("loginSuccess".equals(msg)){
                out.print("alert('登录成功，系统将自动跳转登录页');");
            }
        ...
        function change() {
            var pic = document.getElementById("validateCode");
                ...
                <div class="login">
                    <dl>
                        ...
                        <dd><label for="password">密 码：</label>
                            <input type="password" name="userpassword" class="inputh" value="${userpassword}"
                                   id="password"/></dd>
                        <dd>
                            ...
                            <span class="wordp lf">
                 <img id="validateCode" src="Number.jsp" onclick="this.src=this.src+'?d='+ Math.random();" width="96"
                      height="27" alt=""/>
                            </span>
                            <span class="blues lf"><a id="changeCode" href="javascript:void(0);" onclick="change()"
                                                      title="">看不清</a></span>
                        </dd>
                        <dd>
                            <input id="rem_u" name="auto" type="checkbox" value="true"/>
                            <span class="rem_u">下次自动登录</span>
                            <span style="color: red;font-weight: bolder;font-size: 18px">${errorMsg}</span>
                        </dd>
                        <dd class="buttom">
                            <input name="" type="submit" value="登 录" class="spbg buttombg f14 lf"/>
                            <input id="register" onclick="window.location.href='register.jsp'" name="" type="button"
