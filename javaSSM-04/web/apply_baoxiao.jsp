...
<div class="page-content">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="${pageContext.request.contextPath}/saveStartLeave" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required  class="form-control" id="money" name="money" placeholder="">
                            </div>

                            <div class="form-group">
                                <label for="remark">申请事由</label>
                                <textarea class="form-control" required  rows="15" cols="10" id="remark" name="remark"></textarea>
                            </div>
