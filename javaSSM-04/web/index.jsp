        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="hard-navbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="welcome.jsp?username=${sessionScope.activeUser.username}" class="atip" target="appiframe" data-toggle="tooltip" data-placement="bottom" data-title="首页"><span class="glyphicon glyphicon-home" aria-hidden="true"></span></a></li>
                    <li class="dropdown">
...
<div class="container-fluid mybody">
    <div class="main-wapper">
        ...
        <div id="content" class="main-content">
            ...
            <iframe src="welcome.jsp?username=${activeUser.username}" style="width:100%;height: 100%;" id="appiframe" name="appiframe" frameborder="0"></iframe>
