        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <input type="text"  required class="form-control" id="roleName" name="name" placeholder="">
            ...
            <div class="modal-content">
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control" name="type">
                                    ...
                                    <option value="menu|permission">子菜单|权限</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-dismiss="modal"
                            aria-hidden="true" onclick="document.getElementById('permissionForm').submit()">
                        保存
                    </button>
